          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text(AppStrings.topChair.tr(),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).pushNamed(Routes.allChairsRoute);
                      },
                      child: Container(
                        width: 15,
                        height: 15,
                ...
                children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(widget.chair[index].title.toString(),
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkCart(widget.chair[index].id.toString(), 'Chair',
                          'walid barakat'),
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              await InterActCubit.get(context).toggleCart(
                                  widget.chair[index].id.toString(),
                                  'Chair',
                                  'walid barakat',
                                  '1');
                            },
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkFavorites(widget.chair[index].id.toString(),
                          'Chair', 'walid barakat'),
                    child: BlocConsumer<InterActCubit, InterActState>(
                      listener: (context, state) {
                        if (state is NoInternetState) {
