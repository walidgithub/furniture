...
class SofaView extends StatefulWidget {
  ...
  @override
  State<SofaView> createState() => _SofaViewState();
}

class _SofaViewState extends State<SofaView> {
  @override
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text(AppStrings.topSofa.tr(),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        // Navigator.of(context).pushNamed(Routes.allSofasRoute);
                      },
                      child: Container(
                        width: 15,
                        height: 15,
            ...
            children: List.generate(2, (index) {
              return Stack(
                children: [
                  InkWell(
                    onTap: () {
                      // navigate to sofa details screen
                      // Navigator.of(context).push(MaterialPageRoute(
                      //     builder: (context) => SofaDetailsView(
                      //       idSofa: widget.sofa[index].id,
                      //     )));
                    },
                    child: Container(
                        decoration: BoxDecoration(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(widget.sofa[index].title.toString(),
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkCart(widget.sofa[index].id.toString(), 'Sofa',
                          'walid barakat'),
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkFavorites(widget.sofa[index].id.toString(), 'Sofa',
                          'walid barakat'),
                    child: BlocConsumer<InterActCubit, InterActState>(
                      listener: (context, state) {
                        if (state is NoInternetState) {
