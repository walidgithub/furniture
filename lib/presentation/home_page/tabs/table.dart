          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: Text(AppStrings.topTable.tr(),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        // Navigator.of(context).pushNamed(Routes.allTablesRoute);
                      },
                      child: Container(
                        width: 15,
                        height: 15,
                ...
                children: [
                  InkWell(
                    onTap: () {
                      ...
                      //     builder: (context) => TableDetailsView(
                      //       idTable: widget.table[index].id,
                      //     )));
                    },
                    child: Container(
                        decoration: BoxDecoration(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(widget.table[index].title.toString(),
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkCart(widget.table[index].id.toString(), 'Table',
                          'walid barakat'),
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              await InterActCubit.get(context).toggleCart(
                                  widget.table[index].id.toString(),
                                  'Table',
                                  'walid barakat',
                                  '1');
                            },
                  ...
                  BlocProvider(
                    create: (context) => sl<InterActCubit>()
                      ..checkFavorites(widget.table[index].id.toString(),
                          'Table', 'walid barakat'),
                    child: BlocConsumer<InterActCubit, InterActState>(
                      listener: (context, state) {
                        if (state is NoInternetState) {
