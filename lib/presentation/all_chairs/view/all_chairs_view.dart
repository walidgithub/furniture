...
class AllChairsView extends StatefulWidget {
  const AllChairsView({Key? key}) : super(key: key);

  @override
  State<AllChairsView> createState() => _AllChairsViewState();
}

class _AllChairsViewState extends State<AllChairsView> {
  @override
  ...
  Widget bodyContent() {
    return BlocProvider(
      create: (context) => sl<ChairBloc>()..add(GetAllChairsEvent()),
